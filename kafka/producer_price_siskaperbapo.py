"""
LUMBUNG — Producer harga SISKAPERBAPO Jatim
Owner: Ryan

Menggunakan public API (yfinance) untuk mengambil harga futures komoditas
sebagai proxy harga pangan Siskaperbapo.
"""
...
# Mapping komoditas ke ticker yfinance (Siskaperbapo)
TICKER_MAP = {
    "jagung_pipilan_kering": "ZC=F",
    "kedelai_impor": "ZS=F",
}
